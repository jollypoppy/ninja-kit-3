    ...
    <>
      ...
      <div className="p-5 mt-20 md:mt-35">
        ...
        <div className="h-[65vh] border rounded-lg overflow-y-auto p-3 mb-3 flex flex-col gap-3 md:h-[65vh]">
          <span
            className={`flex flex-col gap-5 bg-blue-200 text-blue-700 py-2 px-4 max-w-[70%] rounded-lg font-semibold `}
          >
            <p>
              Please reply with how would you like to make payments? options
              available:
            </p>
            <ul className="">
              <li> Venmo </li>
